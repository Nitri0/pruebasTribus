...
class packages_gatherer(gatherer):
    ...
    def tables(self):
        return [self.my_config['packages-table'], self.my_config['packages-table'] + '_summary']
    ...
    def run(self):
        ...
        self.add_descriptions = ('descriptions-table' in self.my_config and self.my_config['descriptions-table'])
        cur = self.cursor()
